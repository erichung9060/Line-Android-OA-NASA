...
/**
 * Empty state component shown when there are no favorites.
 *
 * Per ARCHITECTURE.md Section 7.2:
 * - Displayed when favorites list is empty
 */
@Composable
fun EmptyState(
    ...
    Column(
        ...
        Text(
            text = "Long-press on any APOD in Nova to add it to your favorites collection.",
